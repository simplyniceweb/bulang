...
namespace Linkxtr\QrCode\Facades {
    ...
    class QrCode {
        ...
        {
            /** @var \Linkxtr\QrCode\Generator $instance */
         ...
         * @static
         */
        public static function eyeColor($eyeNumber, $innerRed, $innerGreen, $innerBlue, $outerRed = 0, $outerGreen = 0, $outerBlue = 0)
        {
            /** @var \Linkxtr\QrCode\Generator $instance */
            return $instance->eyeColor($eyeNumber, $innerRed, $innerGreen, $innerBlue, $outerRed, $outerGreen, $outerBlue);
        }
...
namespace  {
    ...
    class QrCode extends \Linkxtr\QrCode\Facades\QrCode {}
